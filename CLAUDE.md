# workspace - AI Assistant Instructions

**Package**: `@experimental/workspace`
**Version**: 0.1.0
**Type**: experimental package

## Package Overview

**Description**: Workspace Manager - Project and environment management

**Purpose**: Provide workspace manager - project and environment management functionality for the pkgs ecosystem.
...
1. **Test installation**: `stow workspace`
2. **Test functionality**: Run main commands and verify output
3. **Test uninstallation**: `stow -D workspace`
